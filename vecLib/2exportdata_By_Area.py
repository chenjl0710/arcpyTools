...
'''
2 根据省（或市、或县）、产品分辨率及生产时间在数据集下检索，并输出相应的数据集至文件数据库file geodatabase。
'''
...
for row in cur:
    ...
    # express_prj = 'PRJ_ID =' + "'" + prjid + "'"
    # arcpy.SelectLayerByAttribute_management('project_lyr', 'NEW_SELECTION', express_prj)
    # export_path = os.path.join(file_GDB, prj_id_ + "_meta")
